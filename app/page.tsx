    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-lg border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
              {['features', 'testimonials', 'how-it-works', 'faq'].map((section) => (
                <button
                  ...
                  className="text-gray-700 hover:text-teal-600 transition-colors capitalize relative group text-sm xl:text-base"
                >
                  {section.replace('-', ' ')}
          ...
          {/* Mobile Menu */}
          {mobileMenuOpen && (
            <div className="lg:hidden border-t border-gray-100 py-4 bg-white/95 backdrop-blur-lg relative z-50">
              <nav className="flex flex-col space-y-4">
                {['features', 'testimonials', 'how-it-works', 'faq'].map((section) => (
                  <button
                    ...
                    className="text-gray-700 hover:text-teal-600 transition-colors capitalize text-left py-2 px-2"
                  >
                    {section.replace('-', ' ')}
                  </button>
                ))}
      ...
      <section className="relative pt-16 pb-12 sm:pt-20 sm:pb-16 lg:pt-24 lg:pb-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full">
          ...
          <div className="absolute bottom-10 sm:bottom-20 right-5 sm:right-10 w-64 h-64 sm:w-96 sm:h-96 bg-blue-200/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-4 sm:py-0 sm:px-6 lg:px-8">
          <div className="text-center mb-8 sm:mb-12 lg:mb-16">
            ...
            <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              Master Your Money
              <span className="block bg-gradient-to-r from-teal-600 via-teal-500 to-blue-600 bg-clip-text text-transparent">
                Build Wealth Smart
              </span>
            </h1>

            {/* Subheading - Responsive */}
            <p className={`text-base sm:text-lg md:text-xl lg:text-2xl text-gray-600 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed transition-all duration-1000 delay-300 px-4 sm:px-0 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-6 sm:mb-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              <div className="flex items-center px-3 py-2 bg-blue-50 rounded-lg text-blue-700 text-sm">
                <HardDrive className="h-4 w-4 mr-2" />
                <span>Use Locally (Private)</span>
              </div>
              <div className="text-gray-400 hidden sm:block">or</div>
              <div className="flex items-center px-3 py-2 bg-green-50  rounded-lg text-green-700 text-sm">
            ...
            <div className={`flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 transition-all duration-1000 delay-500 px-4 sm:px-0 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              {user ? (
                ...
                <>
                  ...
                  <Button asChild variant="outline" size="lg" className="w-full sm:w-auto border-2 hover:text-green-800 border-teal-500 text-teal-600 hover:bg-teal-50 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg hover:scale-105 transition-all">
                    <Link href="/signup">
            ...
            <div className={`flex flex-col sm:flex-row flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-8 text-xs sm:text-sm text-gray-500 transition-all duration-1000 delay-700 px-4 sm:px-0 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      ...
      <section id="features" className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            },
            {
              ...
              <div key={index} className="relative group">
                <div className="bg-gradient-to-br from-gray-50 to-white border border-gray-200 rounded-xl sm:rounded-2xl p-6 sm:p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 sm:hover:-translate-y-2">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 bg-${feature.color}-100 rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform`}>
                    <feature.icon className={`h-6 w-6 sm:h-7 sm:w-7 text-${feature.color}-600`} />
                  </div>
          ...
          <div className="mt-12 sm:mt-16 text-center">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-teal-50 to-blue-50 border border-teal-200 rounded-full text-teal-800">
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-r from-teal-500 via-teal-600 to-blue-600 relative overflow-hidden">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-6 sm:mb-8 px-4 sm:px-0">
            {user ? (
              ...
              <>
                ...
                <Button asChild variant="outline" size="lg" className="w-full sm:w-auto border-2 text-green-800 border-white  hover:bg-white hover:text-teal-600 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg shadow-xl hover:shadow-2xl transition-all hover:scale-105">
                  <Link href="/signup">
                    <Cloud className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
                    Sign Up for Cloud Sync
                  </Link>
